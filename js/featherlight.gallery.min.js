...
**/
    !function(a) {
        ...
        function b(c, d) {
            ...
            this.chainCallbacks(g)
        }
        if ("undefined" == typeof a)
            return void ("console"in window && (window.console.info("Too much lightness, Featherlight needs jQuery."),
            "featherlight"in a || window.console.info("Load the featherlight plugin before the gallery plugin")));
        var c = "ontouchstart"in document.documentElement
          ...
          , g = {
            afterClose: function(a, b) {
                ...
                f && (f(c.$instance).off("swipeleft", c._swipeleft),
                f(c.$instance).off("swiperight", c._swiperight)),
                a(b)
            },
            beforeOpen: function() {
                var a = this;
                a.$instance.on("next." + a.namespace + " previous." + a.namespace, function(b) {
                    var c = "next" === b.type ? 1 : -1;
                    a.navigateTo(a.currentNavigation() + c)
                }),
                f ? f(a.$instance).on("swipeleft", a._swipeleft = function() {
                    a.$instance.trigger("next")
                }
                ).on("swiperight", a._swiperight = function() {
                    a.$instance.trigger("previous")
                }
                ) : a.$instance.find("." + a.namespace + "-content").append(a.createNavigation("previous")).append(a.createNavigation("next"))
            },
        ...
        a.extend(b.prototype, {
            ...
            navigateTo: function(b) {
                ...
                c.beforeContent(),
                a.when(c.getContent(), f.fadeTo(c.galleryFadeOut, .2)).done(function(a) {
                    c.setContent(a),
                    c.afterContent(),
